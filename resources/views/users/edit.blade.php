            ...
            <form method="POST" action="{{ route('mypage') }}">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="name" class="text-md-left bookstock-edit-user-info-label">氏名</label>
                    </div>
                    <div class="collapse show editUserName">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus placeholder="野村 太郎">
                        @error('name')
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="email" class="text-md-left bookstock-edit-user-info-label">メールアドレス</label>
                    </div>
                    <div class="collapse show editUserMail">
                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email" autofocus placeholder="book@stock.com">
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                ...
                <hr>
                <button type="submit" class="btn bookstock-submit-button mt-3 w-25">
                    保存
                </button>
            </form>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn bookstock-delete-submit-button">退会する</button>
                                </div>
                            </div>
                        </div>
                    </div>
